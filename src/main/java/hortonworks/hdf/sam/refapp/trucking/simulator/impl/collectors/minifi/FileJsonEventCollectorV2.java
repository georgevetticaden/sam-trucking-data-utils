...
public class FileJsonEventCollectorV2 extends BaseTruckEventCollector {
	...
	public FileJsonEventCollectorV2(String fileName) {
       this.truckEventsFile = new File(fileName);
      
	}
	
	public FileJsonEventCollectorV2(String fileName, EventSourceType eventSource, String minifiAgentIdentifier) {
	       this.truckEventsFile = new File(fileName);
	       this.eventSourceType = eventSource;
	       this.edgeAgentIdentifier = minifiAgentIdentifier;
	...
	private String createTruckSpeedEventJsonString(MobileEyeEvent mee) {
		...
		speedEvent.setEdgeAgentIdentifier(this.edgeAgentIdentifier);
	...
	private String createTruckGeoEventJsonString(MobileEyeEvent mee) {
		...
		geoEvent.setEdgeAgentIdentifier(this.edgeAgentIdentifier);
