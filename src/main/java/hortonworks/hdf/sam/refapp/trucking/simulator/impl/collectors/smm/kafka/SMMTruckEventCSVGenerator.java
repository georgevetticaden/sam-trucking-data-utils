package hortonworks.hdf.sam.refapp.trucking.simulator.impl.collectors.smm.kafka;
...
public class SMMTruckEventCSVGenerator extends BaseTruckEventCollector {
	...
	public SMMTruckEventCSVGenerator(String kafkaBrokerList, String producerName, String topicName, EventSourceType eventSource, SecurityType securityType) {
