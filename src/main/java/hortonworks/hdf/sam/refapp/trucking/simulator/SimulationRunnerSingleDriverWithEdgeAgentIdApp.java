...
public class SimulationRunnerSingleDriverWithEdgeAgentIdApp {
	public static void main(String[] args) {
			try {
				...
				String edgeAgentIdentifer = args[11];
				...
				final ActorRef eventCollector = system.actorOf(
						Props.create(eventCollectorClass, argForCollector, eventSource, edgeAgentIdentifer), "eventCollector");
