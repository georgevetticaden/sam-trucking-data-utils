package hortonworks.hdf.sam.refapp.trucking.simulator.schemaregistry;
...
public class TruckSchemaRegistryLoaderTest {
	...
	//private static final String SCHEMA_REGISTRY_URL = "http://hdf-3-1-release3.field.hortonworks.com:7788/api/v1";
	  private static final String SCHEMA_REGISTRY_URL = "http://connected-dp3.field.hortonworks.com:7788/api/v1";
	...
	@Test
	public void loadSecureSchemaRegistryWithTruckSchemas() {
		registryLoader.loadSchemaRegistry();
	}
...
//	    }	
	...
	private Collection<SerDesInfo> getSerializers(String schemaName) {
		Collection<SerDesInfo> serdes = registryLoader.schemaRegistryClient.getSerDes(schemaName);
		return serdes;
	}
